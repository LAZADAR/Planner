...
const HelloWindow = () => {
  ...
  return (
    <div ref={hello} className={styles.hello}>
      <div ref={hello} className={styles.container}>
        <div className={styles.content}>
          ...
          <h3>
            ...
            visualize your tasks and interact with them conveniently. The
            planner does not store your data on the server, all data is saved on
            your device, and the planner simply displays it. If you have any
            questions, feel free to reach out to us. Have a productive
            experience!
          </h3>
          <h2>Features 🛠️</h2>
          <h3>{`CTRL + ENTER = Add Todo (But remember that to add a task, you need to enter at least a title.)`}</h3>
          <h3>DOUBLE CLICK ON TASK = Done task.</h3>
          <h3>
